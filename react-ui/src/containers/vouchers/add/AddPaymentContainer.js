...
const RenderAddAdditionalCharges = ({ onClick, selectedVouchers }) => {
  return (
    <AgainstVoucherContainer
      onClick={onClick}
    ...
    >
      ...
      {_.size(selectedVouchers) > 0 ? (
        <AgainstVoucherDetails selectedVouchers={selectedVouchers} />
      ) : (
...
const AgainstVoucherDetails = ({ selectedVouchers }) => (
  <div
    style={{
      display: 'flex',
