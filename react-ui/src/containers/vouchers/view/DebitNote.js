...
import AddDebitContianer from '../add/AddDebitNoteContainer';
...
class ViewCreditNote extends Component {
  ...
  getVoucherData() {
    ...
    // this.setState(_=>({selectedVoucher: this.props.selectedVoucher}), ()=>{
  ...
  getShareVoucherData() {
    const { selectedVoucher: { party: { refId }, id } } = this.state;
    this.props
      ...
      <SPCDHelper>
        {({
          ...
          <Container>
            ...
            <AddDebitContianer mode={CONSTANTS.EDIT} />
          </Container>
        )}
      </SPCDHelper>
    );
